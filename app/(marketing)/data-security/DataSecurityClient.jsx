...
'Security measures to help prevent cyberattacks.'
  ...
  },
  {
    ...
    desc: 'Regular security checks protect client information and ensure continuity if disruptions occur. Our teams work together to manage access, respond to incidents and deal with unexpected disruptions.',
    points: [
      'Data is handled only within approved client systems.',
      'Our team follow clear steps to update and manage files.',
      'Daily work activity is tracked and reviewed regularly.',
      'Data is safely deleted or returned when work is completed.'
    ],
  },
];
