...
import {
  MessageCircle, X, ArrowLeft, Bot, Users, CalendarDays, Send,
  Phone, Mail, Clock, ChevronRight, CheckCircle, ExternalLink,
  Calculator, Home as HomeIcon, RefreshCw,
} from 'lucide-react';
      ...
      <div ref={panelRef} className={`cb-panel${isOpen ? ' cb-panel--open' : ''}`} aria-hidden={!isOpen}>
        ...
        <div className="cb-header">
          <div className="cb-header-left">
            {view !== 'home' && (
              <button className="cb-icon-btn cb-back" onClick={() => setView('home')} aria-label="Back">
                <ArrowLeft size={18} />
              </button>
            )}
          ...
          <div className="cb-header-right">
            {view !== 'home' && (
              <button className="cb-icon-btn" onClick={() => setView('home')} aria-label="Home" title="Main menu">
                <HomeIcon size={16} />
              </button>
            )}
        ...
        <div className="cb-body">
          <AnimatePresence mode="wait" initial={false}>
            <motion.div
              ...
              initial={{ opacity: 0, x: view === 'home' ? -12 : 12 }}
